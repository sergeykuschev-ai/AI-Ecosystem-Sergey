...
function buildWorkflowProduct(product, decision) {
  ...
  return {
    ...
    firstRolloutTestAwaiting: product.firstRolloutTestAwaiting === true,
    prePolicyFinalRecommendedQuantity: product.prePolicyFinalRecommendedQuantity ?? null,
    abc: product.abc,
    xyz: product.xyz,
    ...
    onHandStock: product.onHandStock ?? null,
    reserveStock: product.reserveStock ?? null,
    reserveStockSource: product.reserveStockSource || null,
    incomingStock: product.incomingStock ?? null,
    incomingStockSource: product.incomingStockSource || null,
