...
const curated: Record<string, Partial<EditorialProduct>> = {
  '98049E': { slug: 'woodwick-spiced-blackberry-85', description: 'Фруктово-пряный аромат спелой ежевики: терпкие ягоды и апельсиновая цедра, корица и гвоздика, ванильный сахар, бобы тонка и древесные ноты.', scentFamily: 'fruity', mood: 'cozy', room: 'living' },
  'DANHNIR250DEC': { slug: 'danhera-niro-250', description: 'Интерьерный аромат DANHERA NIRO, 250 мл. Детальную пирамиду оставляем без выдуманных нот до подтверждения первоисточником.', room: 'living' },
  'V61028': { slug: 'vellutier-into-the-wilderness-515', description: 'Большая ароматическая свеча Vellutier Into the Wilderness, 515 г.', room: 'living' },
  'V61014': { slug: 'vellutier-midnight-toast-515', description: 'Морские ноты и лимонный тоник переходят в канталупу, цветок апельсина и кокосовую воду; в базе — тик, кедр и замша.', scentFamily: 'woody', mood: 'cozy', room: 'living' },
  'V61036': { slug: 'vellutier-siberian-pine-forest-515', description: 'Сосна, травы, зелёные листья и полынь раскрываются медовым сердцем и базой из кедра, древесины и амбры.', scentFamily: 'woody', mood: 'airy', room: 'living' },
  'V63017': { slug: 'vellutier-vintage-library-90', description: 'Тёмный ром и опопанакс, лабданум и розмарин на тёплой базе бурбонской ванили и сандалового дерева.', scentFamily: 'woody', mood: 'cozy', room: 'study' },
  'V63011': { slug: 'vellutier-oudwood-journey-90', description: 'Цитрусы и корица, олибанум и гвоздика раскрываются пачули, мускусом, амброй и древесными нотами.', scentFamily: 'woody', mood: 'cozy', room: 'study' },
  'V62014': { slug: 'vellutier-midnight-toast-225', description: 'Морские ноты и лимонный тоник переходят в канталупу, цветок апельсина и кокосовую воду; в базе — тик, кедр и замша.', scentFamily: 'woody', mood: 'cozy', room: 'living' },
