...
const curated: Record<string, Partial<EditorialProduct>> = {
  ...
  'ORO500RTFU': { slug: 'teatro-oro-refill-500', description: 'Пряная композиция с чёрным и розовым перцем, гвоздикой и шалфеем; сердце раскрывается франжипани, липой и белыми цветами, база — кедр, пачули и амбра.', scentFamily: 'spicy', mood: 'focused', room: 'living' },
  'LO250TFU': { slug: 'teatro-love-250', description: 'Ягодно-древесная композиция: виноград, земляника, ежевика и малина переходят в кожу, ладан и чёрный перец; база — кедр, бамбук, ветивер и белый мускус.', scentFamily: 'fruity', mood: 'cozy', room: 'living' },
  '655467': { slug: 'teatro-dolce-vaniglia-500', description: 'Гурманская ваниль с сахарной пудрой, тёмным шоколадом и карамелью.', scentFamily: 'warm', mood: 'cozy', room: 'living' },
  'DV500RTFU': { slug: 'teatro-dolce-vaniglia-refill-500', description: 'Рефилл Dolce Vaniglia: сахарная пудра и карамель, тёмный шоколад и цветы ванили, белый мускус и ванильные бобы.', scentFamily: 'warm', mood: 'cozy', room: 'living' },
  'CAND-ROU180': { slug: 'teatro-rose-oud-candle-180', description: 'Ароматическая свеча Rose Oud с насыщенной древесно-цветочной композицией вокруг уда и дамасской розы.', scentFamily: 'woody', mood: 'cozy', room: 'living' },
  'CAND-XM180': { slug: 'teatro-xmas-candle-180', description: 'Праздничная композиция XMAS: апельсин, лимон и мандарин, корица и гвоздика на базе белого мускуса.', scentFamily: 'spicy', mood: 'cozy', room: 'living' },
  ...
  'BAST500NTFU': { slug: 'teatro-black-reeds-500', description: 'Комплект чёрных бамбуковых палочек 36 см для диффузоров формата 500 мл.' },
  '08d97776-bb50-11ef-b425-ed110731e4f3': { slug: 'teatro-natural-reeds-250', description: 'Комплект натуральных бамбуковых палочек 30 см для диффузоров формата 250 мл.' },
  '63a36c45-bb50-11ef-b425-ed110731e4f3': { slug: 'teatro-black-reeds-250', description: 'Комплект чёрных бамбуковых палочек 30 см для диффузоров формата 250 мл.' },
  '83763644-bb50-11ef-b425-ed110731e4f3': { slug: 'teatro-natural-reeds-500', description: 'Комплект натуральных бамбуковых палочек 36 см для диффузоров формата 500 мл.' },
  ...
  '6545367': { slug: 'ladenac-africa-camouflage-candle-350', description: 'Свеча Africa Camouflage 350 г: древесно-пряная композиция с бергамотом, лимоном, специями и розмарином, цветочным сердцем и базой кедра, пачули, мускуса и лабданума.', scentFamily: 'woody', mood: 'focused', room: 'living' },
  ...
  '39393848': { slug: 'ladenac-urban-senses-eau-de-cypres-500', description: 'Eau de Cyprès: герань, розмарин, гальбанум и эвкалипт переходят в кипарис, сосну, лесные ягоды и белые цветы; база — пихтовый бальзам, сандал, кедр и ирис.', scentFamily: 'woody', mood: 'calm', room: 'living' },
  '8411299000985': { slug: 'ladenac-urban-senses-fleurs-de-fruit-500', description: 'Fleurs de Fruit: апельсин, маракуйя, манго и комбава раскрываются тиаре, жасмином, розой и иланг-илангом; база — мускус, кокос, карамелизированная ваниль и мох.', scentFamily: 'fruity', mood: 'airy', room: 'living' },
  '54556': { slug: 'ladenac-vents-arabie-rose-des-sables-500', description: 'Rose des Sables: свежая цветочно-древесная композиция с бергамотом и можжевельником, пачули, цветком апельсина, жасмином и кедром, на тёплой амбровой базе.', scentFamily: 'floral', mood: 'cozy', room: 'living' },
  ...
  'CAND-HOME180': { slug: 'teatro-home-candle-180', description: 'Ароматическая свеча TEATRO HOME Luxury Collection, 180 г.' },
