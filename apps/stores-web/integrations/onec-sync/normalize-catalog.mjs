...
const BRAND_RULES = [
  [/^AWARD\b/i, "AWARD"],
  [/^Мнямс\b/i, "Мнямс"],
  [/^Момент счастья\b/i, "Момент счастья"],
  [/^Alpha\s?Pet\b/i, "AlphaPet"],
  [/^CRAFTIA\b/i, "Craftia"],
  [/^Grandorf\b/i, "Grandorf"],
  [/^Royal\b/i, "Royal"],
  [/^Sirius\b/i, "Sirius"],
  [/^Hill'?s\b/i, "Hill's"],
  [/^INABA\b/i, "INABA"],
  [/^Ranova\b/i, "Ranova"],
  [/^Titbit\b/i, "Titbit"],
  [/^Chewy Snax\b/i, "Chewy Snax"],
  [/^Деревенские Лакомства\b/i, "Деревенские Лакомства"],
  [/^Ферма кота Федора\b/i, "Ферма кота Федора"],
  [/^Кот Федор\b/i, "Кот Федор"],
  [/^Мираторг \(Winner\)\b/i, "Winner"],
  [/^Winner\b/i, "Winner"],
  [/^Cat'?s choice\b/i, "Cat's Choice"],
  [/^Сибирская [Кк]ошка\b/i, "Сибирская кошка"],
  [/^Savanna\b/i, "Savanna"],
  [/^Bambini Pets\b/i, "Bambini Pets"],
  [/^Tetra\b/i, "Tetra"],
  [/^Aquacons\b/i, "Aquacons"],
  [/^Зоомир\b/i, "Зоомир"],
  [/^Аркон\b/i, "Аркон"],
];
const NAME_BRAND_RULES = [
  ...BRAND_RULES,
  [/^Mr\.Kranch\b/i, "Mr.Kranch"],
  [/^Миска Mr\.Kranch\b/i, "Mr.Kranch"],
  [/^GiGwi\b/i, "GiGwi"],
  [/^Pawise\b/i, "Pawise"],
  [/^Keiko\b/i, "Keiko"],
  [/^Dog&Vogue\b/i, "Dog&Vogue"],
  [/\bDog&Vogue\b/i, "Dog&Vogue"],
  [/^Little One\b/i, "Little One"],
  [/^Happy Jungle\b/i, "Happy Jungle"],
  [/^Unitabs\b/i, "Unitabs"],
  [/^flexi\b/i, "Flexi"],
  [/^Flexi\b/i, "Flexi"],
  [/^Animal Play\b/i, "Animal Play"],
  [/^Triol\b/i, "Triol"],
  [/^VitaVet Pro\b/i, "VitaVet Pro"],
  [/^Good Cat\b/i, "Good Cat"],
  [/^Yoriki\b/i, "Yoriki"],
  [/^ISB\b/i, "ISB"],
  [/^Doctor VIC\b/i, "Doctor VIC"],
  [/^Mr\.Bruno\b/i, "Mr.Bruno"],
  [/^Inspector\b/i, "Inspector"],
  [/^Neoterica Vetpro\b/i, "Neoterica Vetpro"],
  [/^Protexin\b/i, "Protexin"],
  [/^Relaxivet\b/i, "Relaxivet"],
  [/^Празител\b/i, "Празител"],
  [/^Дирофен\b/i, "Дирофен"],
  [/^Милпразон\b/i, "Милпразон"],
  [/^Барс\b/i, "Барс"],
  [/^Фитоэлита\b/i, "Фитоэлита"],
  [/^Пчелодар\b/i, "Пчелодар"],
  [/^Cliny\b/i, "Cliny"],
  [/^Zolux\b/i, "Zolux"],
  [/^PerseiLine\b/i, "PerseiLine"],
  [/^Зооник\b/i, "Зооник"],
  [/^Мистер Напкин\b/i, "Мистер Напкин"],
  [/^All For\b/i, "All For"],
];
