...
const BRAND_ALIASES = [
  ...
  ["CO PET", ["co pet"]],
  ["КонтрСекс NEO", ["контрсекс neo"]],
  ["Бриллиантовые Глаза", ["бриллиантовые глаза"]],
  ["PetActive", ["petactive"]],
  ["Good Neem", ["good neem"]],
  ["Green Fort Neo", ["green fort neo"]],
  ["Ветом", ["ветом"]],
  ["Dog Luck", ["dog luck"]],
  ["DoggyMan", ["doggyman"]],
  ["Fitodoc", ["fitodoc"]],
  ...
  ["Пижон", ["пижон"]],
  ["РедПластик", ["редпластик"]],
  ["Good Dog&Cat", ["good dog&cat"]],
  ["Апиценна", ["апиценна"]],
  ["Альпийские луга", ["альпийские луга"]],
  ["Лактобифид", ["лактобифид"]],
  ["Кемаль", ["кемаль"]],
  ["Деревенские Лакомства", ["деревенские лакомства"]],
  ["Ферма кота Фёдора", ["ферма кота федора", "ферма кота фёдора", "кот федор", "кот фёдор"]],
