...
const categoryNames: Record<string, string[]> = {
  miska: ["Корма", "Лакомства", "Наполнители и туалеты", "Уход", "Игрушки", "Амуниция", "Витамины и добавки", "Паразитарные средства"],
  amper: ["Электротовары", "Товары для электромонтажа", "Освещение", "Электроинструмент", "Расходные материалы", "Комплектующие"],
  ventil: ["Сантехника", "Водоснабжение", "Отопление", "Арматура", "Расходные материалы", "Смесители", "Канализация", "Комплектующие"],
...
export const mockFaqs: FAQ[] = [
  ...
  {
    id: "faq-amper-direction",
    question: "Где купить электротовары в Амурске?",
    answer:
      "Электротовары и товары для электромонтажа продаются в магазине «Ампер» на проспекте Победы, 16. Основные направления: электротовары, товары для электромонтажа, освещение, электроинструмент и расходные материалы. Адрес, телефон и режим работы опубликованы на странице торговой точки.",
    brand_id: "brand-amper",
    city_id: "city-amursk",
    store_id: null,
    category_id: null,
    sort_order: 3,
  ...
  {
    id: "faq-ventil-direction",
    question: "Где купить сантехнику в Амурске?",
    answer:
      "Сантехника и товары для водоснабжения и отопления продаются в магазине «Вентиль» на проспекте Победы, 16. Основные направления: сантехника, водоснабжение, отопление, арматура, смесители, канализация и расходные материалы. Адрес, телефон и режим работы опубликованы на странице торговой точки.",
    brand_id: "brand-ventil",
    city_id: "city-amursk",
    store_id: null,
    category_id: null,
    sort_order: 4,
  ...
  {
    id: "faq-metiz-market-direction",
    question: "Где купить крепёж и инструмент в Амурске?",
    answer:
      "Крепёж, метизы и инструмент продаются в магазине «Метиз Маркет» на проспекте Победы, 16. Основные направления: крепёж, саморезы, болты, гайки, анкеры, дюбели, инструмент и расходные материалы. Адрес, телефон и режим работы опубликованы на странице торговой точки.",
    brand_id: "brand-metiz-market",
    city_id: "city-amursk",
    store_id: null,
    category_id: null,
    sort_order: 5,
  ...
  {
    id: "faq-miska-direction",
    question: "Где купить корм и товары для животных в Амурске?",
    answer:
      "Корма и товары для домашних животных продаются в зоомагазине «Миска» на проспекте Победы, 16. Основные направления: корма, лакомства, наполнители и туалеты, уход, игрушки, амуниция, витамины и добавки. Адрес, телефон и режим работы опубликованы на странице торговой точки.",
    brand_id: "brand-miska",
    city_id: "city-amursk",
    store_id: null,
    category_id: null,
    sort_order: 6,
