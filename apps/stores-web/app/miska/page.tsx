...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Зоомагазин «Миска» в Амурске на проспекте Победы, 16: корма для собак и кошек, лакомства, наполнители, товары для ухода, игрушки и амуниция, витамины и добавки, монопротеиновые и ветеринарные рационы.",
  path: "/miska/",
});
