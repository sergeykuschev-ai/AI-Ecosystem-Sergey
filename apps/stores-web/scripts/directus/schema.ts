...
export const schema: CollectionSpec[] = [
  {
    ...
    fields: [
      ...
      decimalField("price", 12, 2, { sort: 20, meta: { translations: ru("Цена Миска") } }),
      decimalField("stock_quantity", 14, 3, { sort: 21, meta: { translations: ru("Остаток Миска") } }),
      decimalField("stock_quantity_raw", 14, 3, { sort: 22, meta: hiddenSystem }),
      timestampField("offers_synced_at", { sort: 23, meta: hiddenSystem }),
      booleanField("active", {
        sort: 24,
        meta: { translations: ru("Активно"), required: true },
        schema: { data_type: "boolean", nullable: false, default: false },
      }),
      timestampField("synced_at", { sort: 25, meta: hiddenSystem }),
    ],
  },
  {
