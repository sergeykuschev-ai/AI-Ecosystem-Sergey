...
async function main() {
  ...
  const urls = normalizeIndexNowUrls(
    [...KEY_RECRAWL_PATHS, ...AMPER_SEO_CATEGORY_PATHS, ...VENTIL_SEO_CATEGORY_PATHS, ...METIZ_SEO_CATEGORY_PATHS, ...MISKA_SEO_CATEGORY_PATHS, ...METIZ_SEO_CATEGORY_PATHS, ...MISKA_SEO_CATEGORY_PATHS, ...MISKA_SEO_CATEGORY_PATHS],
    configuredSiteUrl,
  );
